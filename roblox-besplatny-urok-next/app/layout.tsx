...
export const metadata: Metadata = {
  ...
  description:
    'За одно бесплатное занятие один на один с преподавателем ребёнок соберёт свою игру в Roblox и напишет первый код на Lua. Онлайн, 8–14 лет. За запись — 2 курса в подарок.',
  openGraph: {
    title: 'Программирование в Roblox — бесплатное занятие | Зерокодер',
    description:
      'Ребёнок соберёт свою игру в Roblox и напишет первый код на Lua за одно бесплатное занятие один на один с преподавателем.',
    type: 'website',
    locale: 'ru_RU',
  },
}
