      ...
      <div style={{ maxWidth: '1180px', margin: '0 auto' }}>
        <div className="cta-grid">
          ...
          <div className="cta-left">
            <h2 className="h2 cta-h2" style={{ color: '#FFFFFF', lineHeight: 1.2 }}>
              <span className="cta-h2-lead">Бесплатный открытый урок по&nbsp;нейросетям:</span>
            </h2>
            <p className="cta-sub">
              ребёнок сделает первый проект и&nbsp;увидит, что нейросеть — не&nbsp;способ списать, а&nbsp;способ создавать
            </p>
