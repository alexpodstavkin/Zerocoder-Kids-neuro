  ...
  return (
    <footer className="site-footer">
      ...
      <style>{`
        ...
        .footer-nav a:hover { color: #515CB0; }
        ...
        .footer-contacts-primary a:hover { color: #515CB0; }
        ...
        .footer-socials a:hover { color: #515CB0; border-color: #515CB0; }
        ...
        /* Sticky CTA не должен перекрывать юридическую строку */
