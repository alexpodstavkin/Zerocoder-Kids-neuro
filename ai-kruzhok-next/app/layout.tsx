...
export const metadata: Metadata = {
  title: '5 бесплатных онлайн-занятий по нейросетям для учеников 10–14 лет — Зерокодер',
  description:
    '5 практических онлайн-занятий по нейросетям для учеников 10–14 лет и профориентационный урок один на один со специалистом. Запись до 30 сентября, доступ открывается сразу после регистрации.',
  openGraph: {
    type: 'website',
    locale: 'ru_RU',
    title: '5 бесплатных онлайн-занятий по нейросетям для учеников 10–14 лет — Зерокодер',
