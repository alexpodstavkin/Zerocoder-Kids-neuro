        ...
        <div className="news-card">
          ...
          <div className="news-text">
            ...
            <p className="news-fact">
              По&nbsp;официальному заявлению министра просвещения Сергея Кравцова, с&nbsp;2026&nbsp;года в&nbsp;школьную программу по&nbsp;информатике вводится новый профиль «Искусственный интеллект».
            </p>
            ...
            <details className="news-extra">
              ...
              <blockquote className="news-extra-body">
                <p>
                  «Москва и&nbsp;Подмосковье уже запустили программы: школьники изучают нейросети в&nbsp;рамках уроков информатики. С&nbsp;2026&nbsp;года инициатива распространяется на&nbsp;все школы России.
                </p>
                <p>
