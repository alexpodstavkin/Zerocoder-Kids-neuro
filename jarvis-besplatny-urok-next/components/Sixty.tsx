...
// «За 1 мастер-класс под руководством преподавателя ваш ребёнок» — три ячейки.
      ...
      <div className="container-x">
        <Reveal>
          <h2 className="h2 mx-auto max-w-[820px] text-center">
            За <span className="whitespace-nowrap" style={{ color: 'var(--acc-hot)' }}>
              1 мастер-класс
            </span> под руководством
