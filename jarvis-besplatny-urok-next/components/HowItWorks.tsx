...
const STEPS = [
  {
    ...
    text: 'Оставляете заявку — перезваниваем и подбираем удобный день и час. Мастер-класс один, 60 минут.',
  },
  {
    n: '2',
    title: 'Знакомство',
  ...
  },
  {
    ...
    text: 'После мастер-класса преподаватель расскажет, как всё прошло, и предложит полную программу. Не захотите — ребёнок всё равно останется с готовым помощником.',
  },
]
...
const CALM = [
  ...
  {
    icon: 'user-headset',
    text: 'Мастер-класс индивидуальный: живой преподаватель рядом весь час, ребёнок не сидит один перед экраном.',
  },
  {
    icon: 'tools',
    text: 'Готовых ИИ-помощников сейчас много. Смысл мастер-класса в другом: ребёнок собирает своего сам и понимает, как он устроен изнутри.',
  },
]
      ...
      <div className="container-x">
        <Reveal>
          <h2 className="h2 text-center">
            Как проходит <span className="whitespace-nowrap">мастер-класс</span>
          </h2>
        </Reveal>
